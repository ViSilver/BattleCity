...
class Tank(Figure):
    ...
    def goDown(self):
        ...
        self.height = Tank.height
        self.width = Tank.width
        # print('down: topLeft', self.topLeft)
        # print('down: center before update', self.center)
        # print('down: height->', self.height , 'width ->', self.width)
        self.update_topLeft()
        # print('down: center after update', self.center)
    ...
    def goRight(self):
        ...
        self.height = Tank.width
        self.width = Tank.height
        # print('right: topLeft', self.topLeft)
        # print('right: center before update', self.center)
        # print('right: height->', self.hheight , 'width ->', self.hwidth)
        # self.update_center()
        # print('right: center after update', self.center)
        self.update_topLeft()

    def move(self, direction):
        if direction == 'up' and self.topLeft[0] > 3:
            self.topLeft[0] -= 3
        elif direction == 'down' and self.topLeft[0] + 2 + self.height < BattleMap.height:
            self.topLeft[0] += 3
        elif direction == 'left' and self.topLeft[1] > 3:
            self.topLeft[1] -= 3
    ...
    def update_center(self):
        print('center before update: ', self.center)
        self.center = [self.topLeft[0] + self.height // 2, self.topLeft[1] + self.width // 2]
        print('center after update: ', self.center)

    def update_topLeft(self):
        self.topLeft = [self.center[0] - self.height // 2, self.center[1] - self.width // 2]
