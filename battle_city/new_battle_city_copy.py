...
class Bullet(Figure):
    ...
    def move(self, direction, battleMap):
        print(direction)
        if direction == 'up' and self.center[0] - self.width > self.hwidth:
            self.center[0] -= 3
        elif direction == 'down' and self.center[0] + self.hwidth < BattleMap.height:
            self.center[0] += 3
        elif direction == 'left' and self.center[1] - self.height > 0:
            self.center[1] -= 3
        elif direction == 'right' and self.center[1] + self.width < BattleMap.width:
            self.center[1] += 3
        else:
    ...
    def update_topLeft(self):
        self.topLeft[0] = self.center[0] - self.hwidth
        self.topLeft[1] = self.center[1] - self.hheight
...
class Tank(Figure):
    ...
    def __init__(self):
        ...
        self.center[0] = self.hheight   # y
        self.center[1] = self.hwidth    # x
    ...
    def move(self, direction):
        if direction == 'up' and self.center[0] > self.hheight - 3:
            self.center[0] -= 3
        elif direction == 'down' and self.center[0] + self.hheight + 4 < BattleMap.height:
            self.center[0] += 3
        elif direction == 'left' and self.center[1] > self.hwidth + 4:
            self.center[1] -= 3
        elif direction == 'right' and self.center[1] + self.hwidth + 4 < BattleMap.width:
            self.center[1] += 3
        # print(self.center)
        self.update_topLeft()
    ...
    def update_topLeft(self):
        self.topLeft[0] = self.center[0] - self.hwidth + 1
        self.topLeft[1] = self.center[1] - self.hheight + 1
